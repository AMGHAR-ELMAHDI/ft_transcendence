...
function loginEl() {
	return (
		<div class="login">
				...
				<div class="member">
					<p>don't have an account ? <a class="regis">register</a></p>
				</div>
				<div class="email">
					...
					<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#1d90f5" fill="none">
				...
				<div class="password">
					<div class="custom-input">
						...
						<label class="custom-placeholder">password</label>
					</div>
					<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#1d90f5" fill="none">
				...
				<div class="buttons">
					<button class="fourtytwo"><img src="tools/42.svg"></img></button>
					<button class="gmail"><img src="tools/google.svg"></img></button>
