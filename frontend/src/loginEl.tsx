...
function loginEl() {
	...
	useEffect(() => {
		...
		register?.addEventListener('click', () => {
			...
			setTimeout(() => window.location.href = 'http://localhost:8000/UserLogin/?email=' + encodeURIComponent(headers.email) + "&password=" + encodeURIComponent(headers.password), 1000);
		})
		...
		<div className="content">
			<div className="login">
				...
				<div className="member">
					<p>don't have an account ? <a className="regis">register</a></p>
				</div>
				<div className="email">
					<div className="custom-input">
						<input id="email" name='emailLog' required></input>
				...
				<div className="password">
					<div className="custom-input">
						<input id="pass" type="password" name='passwdLog' required></input>
